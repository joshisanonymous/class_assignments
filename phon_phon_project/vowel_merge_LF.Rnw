...
\begin{document}
  ...
  \begin{abstract}
    ...
    Each speaker's vowel space will be analyzed using Bhattacharyya affinity to determine how much overlap there is in the F1 values of their realizations of [ɑ̃] and [ɔ̃].
