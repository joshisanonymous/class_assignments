  ...
  \section{Introduction}
    \begin{frame}{Cajun Vernacular English (CVE)}
      ...
      \begin{block}{An ethnolect?}
        ...
        % What is attractive about the term vernacular is the focus on `originating in a place where it is used' because this succinctly captures the point we are trying to make about the origins of Cajun English.''
        [bold mine]
      \end{block}
    \end{frame}
