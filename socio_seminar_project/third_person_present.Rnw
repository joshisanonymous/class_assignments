...
\begin{document}
  ...
  \begin{frame}
    \titlepage
    \tiny{Data and code available at \url{https://github.com/joshisanonymous/class_assignments}}
  \end{frame}
  \begin{frame}
    \tableofcontents
  \end{frame}
      ...
      \begin{block}{}
        \begin{table}[h]
          ...
          \begin{tabular}{l @{ } r @{ } r @{ } r @{ } r @{ } r}
            ...
            \hline
            \hline
            Coulson & Male & 6\_ & Baton Rouge & Chataignier & French\\
            Talbot & Male & 6\_ & Youngsville & Lafayette & French\\
            Ward & Male & 4\_ & New Orleans & Gramercy & English\\
            Fitz & Male & 3\_ & Baton Rouge & Baton Rouge & English
          \end{tabular}
        \end{table}
      \end{block}
  ...
  \begin{frame}
    \begin{block}{}
      Data and code avaiable at \url{https://github.com/joshisanonymous/class_assignments}
    \end{block}
  \end{frame}
  \section{References}
